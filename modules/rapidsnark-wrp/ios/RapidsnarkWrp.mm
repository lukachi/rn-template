#import "RapidsnarkWrp.h"

#import <React/RCTLog.h>
#import <react_native_rapidsnark_wrp-Swift.h>

@implementation RapidsnarkWrp
...
{
    return std::make_shared<facebook::react::NativeRapidsnarkWrpSpecJSI>(params);
}
#endif
