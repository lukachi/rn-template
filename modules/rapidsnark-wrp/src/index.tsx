...
const LINKING_ERROR =
  `The package 'react-native-rapidsnark-wrp' doesn't seem to be linked. Make sure: \n\n` +
...
const RapidsnarkWrpModule = isTurboModuleEnabled
  ? require('./NativeRapidsnarkWrp').default
  : NativeModules.RapidsnarkWrp

const RapidsnarkWrp = RapidsnarkWrpModule
  ? RapidsnarkWrpModule
  : new Proxy(
      {},
      {
...
export async function groth16Prove(
  ...
  return RapidsnarkWrp.groth16Prove(
    zkey,
    witness,
    proof_buffer_size,
    public_buffer_size,
...
export async function groth16ProveWithZKeyFilePath(
  ...
  return RapidsnarkWrp.groth16ProveWithZKeyFilePath(
    zkeyPath,
    witness,
    proof_buffer_size,
    public_buffer_size,
...
export function groth16Verify(
  ...
  return RapidsnarkWrp.groth16Verify(proof, inputs, verificationKey, error_buffer_size)
}
...
function groth16PublicSizeForZkeyBuf(
  ...
  return RapidsnarkWrp.groth16PublicSizeForZkeyBuf(zkey, error_buffer_size)
}
...
export function groth16PublicSizeForZkeyFile(
  ...
  return RapidsnarkWrp.groth16PublicSizeForZkeyFile(zkeyPath, error_buffer_size)
}
