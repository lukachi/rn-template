...
export async function witnessBuilder(code: Uint8Array, options?: any) {
  ...
  try {
    ...
    console.log(instance?.exports?.getVersion())
  } catch (err: any) {
    throw new Error(err)
  }
  ...
  const wc = new WitnessCalculatorNative(instance, sanityCheck)
  return wc
...
class WitnessCalculatorNative {
  ...
  sanityCheck: any
  instance: any
  constructor(m: any, sanityCheck: any) {
  ...
  async _doCalculateWitness(input: any, sanityCheck: any) {
    console.log('_doCalculateWitness')
